...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http, CorsConfig corsConfig) throws Exception {
		...
		.authorizeHttpRequests(
		        ...
		        .requestMatchers("/cart-item").hasAnyAuthority("ADMIN", "CUSTOMER", "Admin", "Customer")
		        .requestMatchers("/cart-item/**").hasAnyAuthority("ADMIN", "CUSTOMER", "Admin", "Customer")

		        .requestMatchers(HttpMethod.GET, "/invoice/**").hasAnyAuthority("ADMIN", "CUSTOMER", "Admin", "Customer")
		        .requestMatchers(HttpMethod.POST,"/invoice")
		        .hasAnyAuthority("CUSTOMER", "Customer", "ADMIN", "Admin")
